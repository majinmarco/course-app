    ...
    <div class="container flex flex-col justify-center">
        ...
        <div class="grid content-center w-auto grid-cols-1 gap-6 mx-5 md:grid-cols-2 lg:grid-cols-3">
            @foreach ($courses as $course)
                <a class="w-full h-auto p-4 bg-gray-100 border-2 border-gray-200 rounded-lg shadow-lg select-none hover:shadow-2xl hover:bg-gray-300 active:bg-gray-400 active:border-gray-300"
